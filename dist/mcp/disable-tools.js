...
/**
 * Map from user-facing LMGH_DISABLE_TOOLS group names to ToolCategory values.
...
/**
 * Parse LMGH_DISABLE_TOOLS env var value into a Set of disabled ToolCategory values.
 *
 * Accepts a comma-separated list of group names (case-insensitive).
 * Unknown names are silently ignored.
 *
 * @param envValue - The env var value to parse. Defaults to process.env.LMGH_DISABLE_TOOLS.
 * @returns Set of ToolCategory values that should be disabled.
 *
 * @example
 * // LMGH_DISABLE_TOOLS=lsp,python-repl,project-memory
