...
//
// This file intentionally contains a raw .lmgh construction that bypasses
// resolveSessionStatePaths()/getLmghRoot(). The gate must DETECT this when
...
export function intentionallyWrong(dir) {
  ...
  return join(dir, '.lmgh', 'state', 'fixture.json');
}
