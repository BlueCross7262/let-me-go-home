...
import { STATE_DIR } from '../constants/namespace.js';
...
/**
 * Resolve this plugin's global configuration/cache directory under the active Claude
 * config dir. This keeps hook/updater/HUD caches aligned with CLAUDE_CONFIG_DIR
 * instead of mixing in ~/.lmgh.
 */
export function getLmghConfigDir(): string {
